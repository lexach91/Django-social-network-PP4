...
class TestModels(TestCase):
    ...
    def test_community_creation(self):
        ...
        community = Community.objects.create(
            ...
            bg_image='https://res.cloudinary.com/lexach91/image/upload/v1652420327/community_bg_images/mnf2mkql05rdtpm8r7r4.jpg',
            logo='https://res.cloudinary.com/lexach91/image/upload/v1652425017/community_logos/d3ubcbac1ws1xrsr2koj.png',
            creator=self.user1
        )
        ...
        self.assertEqual(community.bg_image, 'https://res.cloudinary.com/lexach91/image/upload/v1652420327/community_bg_images/mnf2mkql05rdtpm8r7r4.jpg')
        self.assertEqual(community.logo, 'https://res.cloudinary.com/lexach91/image/upload/v1652425017/community_logos/d3ubcbac1ws1xrsr2koj.png')
    ...
    def test_logo_url_propery(self):
        ...
        community.logo = cloudinary.uploader.upload_image('static/images/default-logo.png')
    ...
    def test_bg_image_url_property(self):
        ...
        self.assertEqual(community.bg_image_url, '/static/images/default-bg.jpg')        
        # upload bg image to CloudinaryField
        community.bg_image = cloudinary.uploader.upload_image('static/images/default-bg.jpg')
