...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.user_profile_url = reverse('user_profile', kwargs={'username': self.user2.username})
    ...
    def test_edit_avatar_view(self):
        ...
        response = self.client.post(self.edit_avatar_url, {'avatar': avatar}, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
        self.assertEqual(response.status_code, 200)
    ...
    def test_reset_avatar_view(self):
        ...
        self.client.login(username='user', password='Testuser1')
        response = self.client.post(self.reset_avatar_url, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json()['success'], True)
    ...
    def test_check_online_view(self):
        ...
        self.client.login(username='user', password='Testuser1')
        response = self.client.get(self.check_online_url, {'username': self.user2.username}, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json()['online'], False)
        response = self.client.get(self.check_online_url, {'username': self.user.username}, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_user_view(self):
        ...
        self.client.login(username='user', password='Testuser1')
        response = self.client.post(self.delete_user_url, HTTP_X_REQUESTED_WITH='XMLHttpRequest')
